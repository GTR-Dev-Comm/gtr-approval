...
module.exports = async (req, res) => {
  ...
  const { data, error } = await supabase
    ...
    .select('id, name, login_id, phone, is_active, signup_status, is_team_leader, is_dev_director, is_accounting_reviewer, annual_leave_days, approval_departments(name)')
